...
parser.add_argument('--dut-id', dest='dut_id', default='CE65V2_0',
...
parser.add_argument('--cut', default='1500',
...
def eventCut(evdata):
  ...
  for ix in range(NX):
    ...
    for iy in range(NY):
      ...
      if(abs(val) > SUBMATRIX_CUT and ifr == findMaxChargeFrame(frdata, pol)):
        eventPass = True
  return eventPass
