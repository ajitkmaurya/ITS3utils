...
parser.add_argument('-n', '--nrefs',help='Number of reference ALPIDE planes', default=6, type=int)
parser.add_argument('--charge-max', dest='CHARGE_MAX', help='Max charge for histograms binning', default=10000, type=float)
